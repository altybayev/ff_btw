...
class PostDetailsCopyWidget extends StatefulWidget {
  ...
  @override
  _PostDetailsCopyWidgetState createState() => _PostDetailsCopyWidgetState();
}

class _PostDetailsCopyWidgetState extends State<PostDetailsCopyWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UserPostsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final postDetailsCopyUserPostsRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
                              ...
                              child: ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl: valueOrDefault<String>(
                                    postDetailsCopyUserPostsRecord.postPhoto,
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  if (postDetailsCopyUserPostsRecord
                                          .postOwner ??
                                      true)
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  postDetailsCopyUserPostsRecord.postDescription
                                      .maybeHandleOverflow(
                                    maxChars: 200,
                                    replacement: '…',
                                  ),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ToggleIcon(
                                          ...
                                          value: postDetailsCopyUserPostsRecord
                                              .likes
                                              .toList()
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    final postCommentsCreateData =
                                      ...
                                      post: postDetailsCopyUserPostsRecord
                                          .reference,
                                    );
