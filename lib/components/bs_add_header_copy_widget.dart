...
class BsAddHeaderCopyWidget extends StatefulWidget {
  const BsAddHeaderCopyWidget({
    Key key,
    this.block,
  }) : super(key: key);
  ...
  @override
  _BsAddHeaderCopyWidgetState createState() => _BsAddHeaderCopyWidgetState();
}

class _BsAddHeaderCopyWidgetState extends State<BsAddHeaderCopyWidget> {
